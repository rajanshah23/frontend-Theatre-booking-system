      ...
      {bookings.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {bookings.map((booking) => {
            const dateTimeStr = `${booking.show.date}T${booking.show.time}`;
            ...
            return (
              <div key={booking.id} className="border rounded-lg p-4 flex space-x-6">
                ...
                <div className="flex flex-col justify-center">
                  ...
                  <p>Date: {showDateTime.toLocaleDateString()}</p>
                  <p>Time: {showDateTime.toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" })}</p>
